...
const Result = () => {
  return (
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[68vh]">
        ...
        hover:bg-indigo-600 hover:text-white            hover:shadow-lg 
         hover:scale-105 transition-all duration-500 cursor-pointer"
          ...
          <a
            ...
            border border-transparent hover:from-purple-700 hover:to-indigo-700 
            hover:shadow-lg hover:scale-105 transition-all duration-500 cursor-pointer"
          >
            Download image
          </a>
        </div>
